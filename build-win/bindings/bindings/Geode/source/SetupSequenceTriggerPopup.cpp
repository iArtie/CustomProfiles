...
auto SetupSequenceTriggerPopup::create(SequenceTriggerGameObject* object) -> decltype(create(object)) {
	using FunctionType = decltype(create(object))(*)(SequenceTriggerGameObject*);
	static auto func = wrapFunction<FunctionType>(base::get() + 0x443310, tulip::hook::TulipConvention::Default);
...
auto SetupSequenceTriggerPopup::onCustomToggleTriggerValue(cocos2d::CCObject* sender) -> decltype(onCustomToggleTriggerValue(sender)) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x444650, tulip::hook::TulipConvention::Thiscall);
	return reinterpret_cast<FunctionType>(func)(self, sender);
}

auto SetupSequenceTriggerPopup::init(SequenceTriggerGameObject* object) -> decltype(init(object)) {
	using FunctionType = decltype(init(object))(*)(SetupSequenceTriggerPopup*, SequenceTriggerGameObject*);
	static auto func = wrapFunction<FunctionType>(base::get() + 0x443440, tulip::hook::TulipConvention::Thiscall);
...
auto SetupSequenceTriggerPopup::onAddChance(cocos2d::CCObject* sender) -> decltype(onAddChance(sender)) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x444ca0, tulip::hook::TulipConvention::Thiscall);
...
auto SetupSequenceTriggerPopup::onChangeOrder(cocos2d::CCObject* sender) -> decltype(onChangeOrder(sender)) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x444de0, tulip::hook::TulipConvention::Thiscall);
	return reinterpret_cast<FunctionType>(func)(this, sender);
}
...
auto SetupSequenceTriggerPopup::onDeleteSelected(cocos2d::CCObject* sender) -> decltype(onDeleteSelected(sender)) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x444ec0, tulip::hook::TulipConvention::Thiscall);
	return reinterpret_cast<FunctionType>(func)(this, sender);
}
...
auto SetupSequenceTriggerPopup::onSelect(cocos2d::CCObject* sender) -> decltype(onSelect(sender)) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x444c20, tulip::hook::TulipConvention::Thiscall);
	return reinterpret_cast<FunctionType>(func)(this, sender);
}
...
auto SetupSequenceTriggerPopup::updateGroupIDButtons() -> decltype(updateGroupIDButtons()) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x444740, tulip::hook::TulipConvention::Thiscall);
