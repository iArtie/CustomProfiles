...
cocos2d::CCRepeatForever::~CCRepeatForever() {
	...
	if (!geode::DestructorLock::isLocked(this)) {
		...
		static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCRepeatForever@cocos2d@@UEAA@XZ")), tulip::hook::TulipConvention::Thiscall);
