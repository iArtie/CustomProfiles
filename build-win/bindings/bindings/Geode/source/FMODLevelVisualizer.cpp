...
auto FMODLevelVisualizer::create() -> decltype(create()) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x29e7b0, tulip::hook::TulipConvention::Default);
...
auto FMODLevelVisualizer::init() -> decltype(init()) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x29e830, tulip::hook::TulipConvention::Thiscall);
...
auto FMODLevelVisualizer::updateVisualizer(float volume, float peak, float time) -> decltype(updateVisualizer(volume, peak, time)) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x29ecf0, tulip::hook::TulipConvention::Thiscall);
