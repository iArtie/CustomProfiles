...
auto NumberInputLayer::init() -> decltype(init()) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x348400, tulip::hook::TulipConvention::Thiscall);
...
auto NumberInputLayer::onNumber(cocos2d::CCObject* sender) -> decltype(onNumber(sender)) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x3489b0, tulip::hook::TulipConvention::Thiscall);
	return reinterpret_cast<FunctionType>(func)(this, sender);
}
...
auto NumberInputLayer::updateNumberState() -> decltype(updateNumberState()) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x348b40, tulip::hook::TulipConvention::Thiscall);
