...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionMoveInB> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionMoveInB>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??0CCTransitionMoveInB@cocos2d@@QEAA@XZ")), Thiscall, cocos2d::CCTransitionMoveInB, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCTransitionMoveInB@cocos2d@@UEAA@XZ")), Thiscall, cocos2d::CCTransitionMoveInB)
