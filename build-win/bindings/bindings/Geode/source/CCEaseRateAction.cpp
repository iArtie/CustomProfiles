...
cocos2d::CCEaseRateAction::~CCEaseRateAction() {
	...
	if (!geode::DestructorLock::isLocked(this)) {
		...
		static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCEaseRateAction@cocos2d@@UEAA@XZ")), tulip::hook::TulipConvention::Thiscall);
