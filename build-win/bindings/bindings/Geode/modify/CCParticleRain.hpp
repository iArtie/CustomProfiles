...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParticleRain> : ModifyBase<ModifyDerive<Der, cocos2d::CCParticleRain>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::CCParticleRain::initWithTotalParticles)), Thiscall, cocos2d::CCParticleRain, initWithTotalParticles, unsigned int)
		}
	};
}
