...
cocos2d::extension::CCControlHuePicker::CCControlHuePicker() : cocos2d::extension::CCControlHuePicker(geode::CutoffConstructor, sizeof(cocos2d::extension::CCControlHuePicker)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getExtensions(), "??0CCControlHuePicker@extension@cocos2d@@QEAA@XZ")), tulip::hook::TulipConvention::Thiscall);
...
cocos2d::extension::CCControlHuePicker::~CCControlHuePicker() {
	...
	if (!geode::DestructorLock::isLocked(this)) {
		using FunctionType = void(*)(cocos2d::extension::CCControlHuePicker*);
		static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getExtensions(), "??1CCControlHuePicker@extension@cocos2d@@UEAA@XZ")), tulip::hook::TulipConvention::Thiscall);
		reinterpret_cast<FunctionType>(func)(this);
