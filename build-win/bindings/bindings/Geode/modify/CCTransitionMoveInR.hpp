...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionMoveInR> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionMoveInR>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??0CCTransitionMoveInR@cocos2d@@QEAA@XZ")), Thiscall, cocos2d::CCTransitionMoveInR, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCTransitionMoveInR@cocos2d@@UEAA@XZ")), Thiscall, cocos2d::CCTransitionMoveInR)
