...
cocos2d::CCDictElement::~CCDictElement() {
	...
	if (!geode::DestructorLock::isLocked(this)) {
		...
		static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCDictElement@cocos2d@@QEAA@XZ")), tulip::hook::TulipConvention::Thiscall);
