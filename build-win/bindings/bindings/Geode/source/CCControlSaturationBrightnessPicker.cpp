...
cocos2d::extension::CCControlSaturationBrightnessPicker::CCControlSaturationBrightnessPicker() : cocos2d::extension::CCControlSaturationBrightnessPicker(geode::CutoffConstructor, sizeof(cocos2d::extension::CCControlSaturationBrightnessPicker)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getExtensions(), "??0CCControlSaturationBrightnessPicker@extension@cocos2d@@QEAA@XZ")), tulip::hook::TulipConvention::Thiscall);
...
cocos2d::extension::CCControlSaturationBrightnessPicker::~CCControlSaturationBrightnessPicker() {
	...
	if (!geode::DestructorLock::isLocked(this)) {
		using FunctionType = void(*)(cocos2d::extension::CCControlSaturationBrightnessPicker*);
		static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getExtensions(), "??1CCControlSaturationBrightnessPicker@extension@cocos2d@@UEAA@XZ")), tulip::hook::TulipConvention::Thiscall);
		reinterpret_cast<FunctionType>(func)(this);
