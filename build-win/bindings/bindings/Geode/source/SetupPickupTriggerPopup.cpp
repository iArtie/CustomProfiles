...
auto SetupPickupTriggerPopup::create(EffectGameObject* object, cocos2d::CCArray* objects) -> decltype(create(object, objects)) {
	using FunctionType = decltype(create(object, objects))(*)(EffectGameObject*, cocos2d::CCArray*);
	static auto func = wrapFunction<FunctionType>(base::get() + 0x436a10, tulip::hook::TulipConvention::Default);
...
auto SetupPickupTriggerPopup::onPlusButton(cocos2d::CCObject* sender) -> decltype(onPlusButton(sender)) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x437240, tulip::hook::TulipConvention::Thiscall);
...
auto SetupPickupTriggerPopup::onCustomToggleTriggerValue(cocos2d::CCObject* sender) -> decltype(onCustomToggleTriggerValue(sender)) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x437360, tulip::hook::TulipConvention::Thiscall);
	return reinterpret_cast<FunctionType>(func)(self, sender);
}

auto SetupPickupTriggerPopup::init(EffectGameObject* object, cocos2d::CCArray* objects) -> decltype(init(object, objects)) {
	using FunctionType = decltype(init(object, objects))(*)(SetupPickupTriggerPopup*, EffectGameObject*, cocos2d::CCArray*);
	static auto func = wrapFunction<FunctionType>(base::get() + 0x436b20, tulip::hook::TulipConvention::Thiscall);
...
auto SetupPickupTriggerPopup::updateState() -> decltype(updateState()) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x4372f0, tulip::hook::TulipConvention::Thiscall);
