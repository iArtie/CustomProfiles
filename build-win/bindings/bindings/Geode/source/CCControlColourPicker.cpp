...
cocos2d::extension::CCControlColourPicker::CCControlColourPicker() : cocos2d::extension::CCControlColourPicker(geode::CutoffConstructor, sizeof(cocos2d::extension::CCControlColourPicker)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getExtensions(), "??0CCControlColourPicker@extension@cocos2d@@QEAA@XZ")), tulip::hook::TulipConvention::Thiscall);
...
cocos2d::extension::CCControlColourPicker::~CCControlColourPicker() {
	...
	if (!geode::DestructorLock::isLocked(this)) {
		using FunctionType = void(*)(cocos2d::extension::CCControlColourPicker*);
		static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getExtensions(), "??1CCControlColourPicker@extension@cocos2d@@UEAA@XZ")), tulip::hook::TulipConvention::Thiscall);
		reinterpret_cast<FunctionType>(func)(this);
