...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionFlipAngular> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionFlipAngular>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??0CCTransitionFlipAngular@cocos2d@@QEAA@XZ")), Thiscall, cocos2d::CCTransitionFlipAngular, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCTransitionFlipAngular@cocos2d@@UEAA@XZ")), Thiscall, cocos2d::CCTransitionFlipAngular)
