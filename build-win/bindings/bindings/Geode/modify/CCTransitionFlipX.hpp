...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionFlipX> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionFlipX>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??0CCTransitionFlipX@cocos2d@@QEAA@XZ")), Thiscall, cocos2d::CCTransitionFlipX, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCTransitionFlipX@cocos2d@@UEAA@XZ")), Thiscall, cocos2d::CCTransitionFlipX)
