...
cocos2d::CCActionInstant::CCActionInstant() : cocos2d::CCActionInstant(geode::CutoffConstructor, sizeof(cocos2d::CCActionInstant)) {
	...
	static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??0CCActionInstant@cocos2d@@QEAA@XZ")), tulip::hook::TulipConvention::Thiscall);
