...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParticleFire> : ModifyBase<ModifyDerive<Der, cocos2d::CCParticleFire>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<unsigned int>::func(&cocos2d::CCParticleFire::initWithTotalParticles)), Thiscall, cocos2d::CCParticleFire, initWithTotalParticles, unsigned int)
		}
	};
}
