...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupAreaTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupAreaTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(SetupAreaTriggerPopup, create, EnterEffectObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4108c0, Thiscall, SetupAreaTriggerPopup, init, EnterEffectObject*, cocos2d::CCArray*)
		}
	};
}
