...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCCircleAlert> : ModifyBase<ModifyDerive<Der, CCCircleAlert>> {
		...
		void apply() override {
            ...
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCCircleAlert, create, float, float, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(CCCircleAlert, init, float, float, float)
		}
	};
}
