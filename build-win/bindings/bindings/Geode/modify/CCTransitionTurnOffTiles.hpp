...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTransitionTurnOffTiles> : ModifyBase<ModifyDerive<Der, cocos2d::CCTransitionTurnOffTiles>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??0CCTransitionTurnOffTiles@cocos2d@@QEAA@XZ")), Thiscall, cocos2d::CCTransitionTurnOffTiles, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCTransitionTurnOffTiles@cocos2d@@UEAA@XZ")), Thiscall, cocos2d::CCTransitionTurnOffTiles)
