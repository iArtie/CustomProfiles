...
auto SongsLayer::create() -> decltype(create()) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x494660, tulip::hook::TulipConvention::Default);
...
auto SongsLayer::customSetup() -> decltype(customSetup()) {
	...
	static auto func = wrapFunction<FunctionType>(base::get() + 0x494730, tulip::hook::TulipConvention::Thiscall);
