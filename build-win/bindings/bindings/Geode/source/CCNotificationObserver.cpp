...
cocos2d::CCNotificationObserver::~CCNotificationObserver() {
	...
	if (!geode::DestructorLock::isLocked(this)) {
		...
		static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCNotificationObserver@cocos2d@@UEAA@XZ")), tulip::hook::TulipConvention::Thiscall);
