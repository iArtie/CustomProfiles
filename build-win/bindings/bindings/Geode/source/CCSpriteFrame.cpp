...
cocos2d::CCSpriteFrame::~CCSpriteFrame() {
	...
	if (!geode::DestructorLock::isLocked(this)) {
		...
		static auto func = wrapFunction<FunctionType>(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCSpriteFrame@cocos2d@@UEAA@XZ")), tulip::hook::TulipConvention::Thiscall);
